        ...
        <div class="select-trigger">
          ...
          >
            ...
            <transition v-if="!collapseTags" @after-leave="resetInputHeight">
              <span :style="{'margin-left': prefixWidth && selected.length ? `${prefixWidth}px` : null}">
                <el-tag
            ...
            <input
              ...
              :style="{ 'margin-left': prefixWidth && !selected.length || tagInMultiLine ? `${prefixWidth}px` : null, 'flex-grow': '1', width: inputLength / (inputWidth - 32) + '%', 'max-width': inputWidth - 42 + 'px' }"
              @focus="handleFocus"
              @blur="handleBlur"
